...
<body>
	...
	<header class="container-fluid header">
		<div class="container">
			<a href="accueil_co.php" class="logo">Robert Schuman</a>
			<nav class="menu">
			<a href="deconnexion_siteweb.php" class="btn-connexion"><i class="fas fa-sign-out-alt"></i> Déconnexion</a>
			<a href="parametre_siteweb.php" class="btn-inscription"><i class="fas fa-cog"></i> Paramètre</a>
			</nav>
		</div>
	</header>
			  ...
			  <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
			    <div class="card">
			      <div class="card-body">
			        ...
			        <a href="info_siteweb.php" class="btn btn-custom"><i class="fas fa-info-circle"></i> Informations diverses</a>
			      </div>
			    </div>
			  </div>
			   <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
			...
			<div class="row">
			  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
				  ...
				  <div class="card-header">
				    <i class="fas fa-clipboard"></i> Pronote
				  </div>
				  <div class="card-body">
				    <h5 class="card-title">Vous êtes connecter !</h5>
				    <p class="card-text">Vous pouvez désormais accéder à Pronote en cliquant sur le bouton ci-dessous</p>
				    <a href="https://0931573e.index-education.net/pronote/" class="btn btn-custom"><i class="fas fa-clipboard"></i> Pronote</a>
				  </div>
				</div>
			  </div>
			</div>
